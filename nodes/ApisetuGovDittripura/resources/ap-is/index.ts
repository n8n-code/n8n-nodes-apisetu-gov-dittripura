...
export const apIsDescription: INodeProperties[] = [
			...
			"options": [
				...
				},
				{
					"name": "Dpcer",
					"value": "Dpcer",
					"action": "Dependency Certificate",
					"description": "API to verify Dependency Certificate.",
					"routing": {
						"request": {
							"method": "POST",
							"url": "=/dpcer/certificate"
						}
					}
				},
				{
					"name": "Fslcs",
					"value": "Fslcs",
					"action": "Food Stuff License",
					"description": "API to verify Food Stuff License.",
					"routing": {
						"request": {
							"method": "POST",
							"url": "=/fslcs/certificate"
						}
					}
				},
				{
					"name": "Grred",
					"value": "Grred",
					"action": "Grievance Redressal/ Registration",
					"description": "API to verify Grievance Redressal/ Registration.",
					"routing": {
						"request": {
							"method": "POST",
							"url": "=/grred/certificate"
						}
					}
				},
				{
				...
				},
				{
					"name": "Isoal",
					"value": "Isoal",
					"action": "Issue of Arm Licence",
					"description": "API to verify Issue of Arm Licence.",
					"routing": {
						"request": {
							"method": "POST",
							"url": "=/isoal/certificate"
						}
					}
				},
				{
					"name": "Lvcer",
					"value": "Lvcer",
					"action": "Land Valuation/ Holding/ Record Certificate",
					"description": "API to verify Land Valuation/ Holding/ Record Certificate.",
					"routing": {
						"request": {
							"method": "POST",
							"url": "=/lvcer/certificate"
						}
					}
				},
				{
					"name": "Malcs",
					"value": "Malcs",
					"action": "Manufacturer License",
					"description": "API to verify Manufacturer License.",
					"routing": {
						"request": {
							"method": "POST",
							"url": "=/malcs/certificate"
						}
					}
				},
				{
					"name": "Mpkby",
					"value": "Mpkby",
					"action": "Small Savings Agent License",
					"description": "API to verify Small Savings Agent License.",
					"routing": {
						"request": {
							"method": "POST",
							"url": "=/mpkby/certificate"
						}
					}
				},
				{
				...
				},
				{
					"name": "Ritin",
					"value": "Ritin",
					"action": "Right to Information",
					"description": "API to verify Right to Information.",
					"routing": {
						"request": {
							"method": "POST",
							"url": "=/ritin/certificate"
						}
					}
				},
				{
				...
				},
				{
					"name": "Smcer",
					"value": "Smcer",
					"action": "Surviving Member Certificate",
					"description": "API to verify Surviving Member Certificate.",
					"routing": {
						"request": {
							"method": "POST",
							"url": "=/smcer/certificate"
						}
					}
				},
				{
					"name": "Sslcs",
					"value": "Sslcs",
					"action": "Standardized Agency Systems (SAS) Agent License",
					"description": "API to verify Standardized Agency Systems (SAS) Agent License.",
					"routing": {
						"request": {
							"method": "POST",
							"url": "=/sslcs/certificate"
						}
					}
				},
				{
					"name": "Vrwmi",
					"value": "Vrwmi",
					"action": "License/ Verification of Weights, Measures and Instruments",
					"description": "API to verify License/ Verification of Weights, Measures and Instruments.",
					"routing": {
						"request": {
							"method": "POST",
							"url": "=/vrwmi/certificate"
						}
					}
				}
			],
		...
		{
			"displayName": "POST /dncer/certificate",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
		...
		{
			"displayName": "POST /dpcer/certificate",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
		...
		{
			"displayName": "POST /fslcs/certificate",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
		...
		{
			"displayName": "POST /grred/certificate",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
		...
		{
			"displayName": "POST /isoal/certificate",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
		...
		{
			"displayName": "POST /lvcer/certificate",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
		...
		{
			"displayName": "POST /malcs/certificate",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
		...
		{
			"displayName": "POST /mpkby/certificate",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
		...
		{
			"displayName": "POST /ritin/certificate",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
		...
		{
			"displayName": "POST /smcer/certificate",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
		...
		{
			"displayName": "POST /sslcs/certificate",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
		...
		{
			"displayName": "POST /vrwmi/certificate",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
